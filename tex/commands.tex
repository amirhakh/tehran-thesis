...
\usepackage[a4paper, top=35mm, bottom=30mm, outer=25mm, inner=35mm]{geometry}
...
\usepackage{lastpage}
% بستهٔ لازم برای: ۱. تغییر شماره‌گذاری صفحات پیوست. ۲. تصحیح باگ آدرس وب حاوی '%' در مراجع
\usepackage{etoolbox}
...
\ifdraft
{%
	% بستهٔ ایجاد لینک‌های رنگی با امکان جهش
...
% بستهٔ نوشتن متن با چند ستون هم تراز
\usepackage{multicol}
...
% remove localise=on, to compile


\makeatletter
% تعریف قلم فارسی و انگلیسی و مکان قلم‌ها
\if@irfonts
	\settextfont[Path={./font/}, BoldFont={IRLotusICEE_Bold.ttf}, BoldItalicFont={IRLotusICEE_BoldIranic.ttf}, ItalicFont={IRLotusICEE_Iranic.ttf},Scale=1.15]{IRLotusICEE.ttf}
	% LiberationSerif or FreeSerif as free equivalents of Times New Roman
	\setlatintextfont[Path={./font/}, BoldFont={LiberationSerif-Bold.ttf}, BoldItalicFont={LiberationSerif-BoldItalic.ttf}, ItalicFont={LiberationSerif-Italic.ttf},Scale=1]{LiberationSerif-Regular.ttf}
	% چنانچه می‌خواهید اعداد در فرمول‌ها، انگلیسی باشد، خط زیر را غیرفعال کنید
	% و گزینهٔ displaymathdigits=persian را از خط ۱۰۹ حذف کنید.
	\setdigitfont[Path={./font/}, Scale=1.15]{IRLotusICEE.ttf}
	% تعریف قلم‌های فارسی و انگلیسی اضافی برای استفاده در بعضی از قسمت‌های متن
	\setiranicfont[Path={./font/}, Scale=1.15]{IRLotusICEE_Iranic.ttf}				% ایرانیک، خوابیده به چپ
...
\newcommand{\algorithmautorefname}{الگوریتم}
\renewcommand{\equationautorefname}{معادلهٔ}
...
% حذف تورفتگی برای بخش‌ها
\setlength{\cftsecindent}{10pt}
\setlength{\cftsubsecindent}{20pt} % تورفتگی دلخواه برای زیر‌بخش‌ها
\setlength{\cftsubsubsecindent}{30pt} % برای زیرزیر‌بخش‌ها
